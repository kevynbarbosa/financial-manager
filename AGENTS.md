...
This is a Laravel + Vue 3 + Inertia.js starter kit with SSR support. It includes authentication, user management, and a modern component library built with reka-ui/shadcn-vue and Tailwind CSS.

## Common Development Commands

### PHP/Laravel Commands
- `composer dev` - Start development environment (combines Laravel server, queue worker, logs, and Vite)
- `composer dev:ssr` - Start development with SSR enabled
- `composer test` - Run PHP tests (Laravel Pest)
...
- `npm run lint` - Lint and fix JavaScript/Vue files (ESLint)
...
- **Build Tool**: Vite
- **Key directories**:
  - `resources/js/pages/` - Inertia pages (Welcome.vue, Dashboard.vue, auth/, settings/)
  - `resources/js/components/` - Reusable Vue components
  - `resources/js/components/ui/` - UI component library (shadcn-vue style)
  - `resources/js/composables/` - Vue composables (e.g., useAppearance for theming)

### Component System
- Uses reka-ui (headless UI components) with shadcn-vue styling
...
- Use `npm run build:ssr` to build SSR bundle
...
6. Start development: `composer dev` (recommended) or separate commands
